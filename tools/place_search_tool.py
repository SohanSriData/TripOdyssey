...
class PlaceSearchTool:
    def __init__(self):
        ...
        if not self.google_api_key:
            raise ValueError(
                "Missing Google Places API key. Set GPLACES_API_KEY in .env or environment variables."
            )
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place: str) -> str:
            """Search for attractions in a place using Google Places or Tavily fallback."""
            try:
        ...
        def search_restaurants(place: str) -> str:
            """Search for restaurants in a place using Google Places or Tavily fallback."""
            try:
        ...
        def search_activities(place: str) -> str:
            """Search for activities in a place using Google Places or Tavily fallback."""
            try:
        ...
        def search_transportation(place: str) -> str:
            """Search for transportation options in a place using Google Places or Tavily fallback."""
            try:
